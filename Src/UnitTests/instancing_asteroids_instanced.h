...
int main()
{
	...
	{
		cout << "===== Plant Shader" << std::endl;
		// Load Shader
		std::string  vShaderCode = FUtilityHelper::ReadTextFile("shaders\\planet.vs");
		std::string  pShaderCode = FUtilityHelper::ReadTextFile("shaders\\planet.frag");
	...
	{
		cout << "===== instanced_asteroids Shader" << std::endl;
		// Load Shader
		std::string  vShaderCode = FUtilityHelper::ReadTextFile("shaders\\instanced_asteroids.vs");
		std::string  pShaderCode = FUtilityHelper::ReadTextFile("shaders\\instanced_asteroids.frag");
    ...
    // Load models
    Model rock(FileSystem::getPath("objects/rock/rock.obj").c_str());
    Model planet(FileSystem::getPath("objects/planet/planet.obj").c_str());
