...
int main()
{
	...
	Shader shaderGeometryPass("shaders/g_buffer.vs", "shaders/g_buffer.frag");
	Shader shaderLightingPass("shaders/deferred_shading.vs", "shaders/deferred_shading.frag");
	Shader shaderLightBox("shaders/deferred_light_box.vs", "shaders/deferred_light_box.frag");
	...
	// Models
	Model cyborg(FileSystem::getPath("objects/nanosuit/nanosuit.obj").c_str());
