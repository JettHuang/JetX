...
int main()
{
    ...
    Shader shaderGeometryPass("shaders/ssao_geometry.vs", "shaders/ssao_geometry.frag");
    Shader shaderLightingPass("shaders/ssao.vs", "shaders/ssao_lighting.frag");
    Shader shaderSSAO("shaders/ssao.vs", "shaders/ssao.frag");
    Shader shaderSSAOBlur("shaders/ssao.vs", "shaders/ssao_blur.frag");
    ...
    // Objects
    Model nanosuit(FileSystem::getPath("objects/nanosuit/nanosuit.obj").c_str());
